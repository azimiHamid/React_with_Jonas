...
export default function App() {
  return (
    <div>
      ...
      1st one <ProductList /> is just a simple list. but the productsWithToggles wrapped the same ProductList with two toggle button functionalities 
       */}
        <ProductList title="Products Original" items={products} />
